# Swagger\Client\ScheduledTasksApi
...
# **getTask**
> \Swagger\Client\Model\TaskInfo getTask($task_id)
...
$apiInstance = new Swagger\Client\Api\ScheduledTasksApi(
...
[**\Swagger\Client\Model\TaskInfo**](../Model/TaskInfo.md)
...
# **getTasks**
> \Swagger\Client\Model\TaskInfo[] getTasks($is_hidden, $is_enabled)
...
$body = array(new \Swagger\Client\Model\TaskTriggerInfo()); // \Swagger\Client\Model\TaskTriggerInfo[] | Triggers.
$task_id = "task_id_example"; // string | Task Id.

try {
    $apiInstance->updateTask($body, $task_id);
} catch (Exception $e) {
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **body** | [**\Swagger\Client\Model\TaskTriggerInfo[]**](../Model/TaskTriggerInfo.md)| Triggers. |
 **task_id** | **string**| Task Id. |
